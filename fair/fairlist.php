        ...
        <table class="table sakotable table-bordered table-striped dt-responsive">
          <thead>
            <tr>
              ...
              <th><?php echo $_data['add_new_form_field_text_20'];?></th>
              <th><?php echo $_data['add_new_form_field_text_21'];?></th>
          ...
          <tbody>
        <?php
		      $result = mysqli_query($link,"Select *,ar.image as r_image,ar.r_name,fl.floor_no as fl_floor,u.unit_no as u_unit from tbl_add_fair f inner join tbl_add_floor fl on fl.fid = f.floor_no inner join tbl_add_unit u on u.uid = f.unit_no inner join tbl_add_rent ar on ar.rid = f.rid where f.type = 'Rented' and f.branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " order by f.f_id desc");
          while($row = mysqli_fetch_array($result)){
            ...
            <tr>
              ...
              <td><?php echo $row['term']." ".$_data['add_new_rent_months']; ?></td>
              ...
              <td>
                <a target="_blank" class="btn btn-info ams_btn_special" data-original-title="<?php echo $_data['invoice_no'];?>" data-toggle="tooltip" href="<?php echo WEB_URL;?>fair/invoice.php?rentid=<?php echo $row['f_id']; ?>"><i class="fa fa-file-text-o"></i></a> 
                ...
                <a class="btn btn-warning ams_btn_special" data-toggle="tooltip" href="<?php echo WEB_URL;?>fair/addfair.php?id=<?php echo $row['f_id']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a>  
                <a class="btn btn-danger ams_btn_special" data-toggle="tooltip" onClick="deleteFair(<?php echo $row['f_id']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-6">                         
                            ...
                            <b><?php echo $_data['add_new_form_field_text_20'];?> :</b> <?php echo $row['term']." ".$_data['add_new_rent_months']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_21'];?> :</b> <?php echo $row['agreement_no']; ?><br/>
