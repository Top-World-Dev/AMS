...
if(isset($_GET['id']) && $_GET['id'] != ''){
	...
	if($row = mysqli_fetch_array($result)){
		$r_name = $row['r_name'];
		$r_waterno = $row['r_waterno'];
		$r_electricno = $row['r_electricno'];
		$r_email = $row['r_email'];
    ...
    <div class="box box-success">
      ...
      <form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data" id="frm_renter_entry">
        <div class="box-body row">
		  ...
		  <div class="form-group col-md-6">
		  	<label for="txtWaterNo"><?php echo $_data['add_new_form_field_text_18'];?> :</label>
			<input type="text" name="txtWaterNo" value="<?php echo $r_waterno;?>" id="txtWaterNo" class="form-control" />
		  </div>
		  <div class="form-group col-md-6">
		  	<label for="txtElectricNo"><?php echo $_data['add_new_form_field_text_19'];?> :</label>
			<input type="text" name="txtElectricNo" value="<?php echo $r_electricno;?>" id="txtElectricNo" class="form-control" />
		  </div>		  
          <div class="form-group col-md-12">
